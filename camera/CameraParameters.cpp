...
const char CameraParameters::FACE_FILTER_FACEDETECT[] = "face-filter-facedetect";
const char CameraParameters::FACE_FILTER_OFF[] = "off";
const char CameraParameters::FLASH_MODE_TORCH_FLASH[] = "torch-flash";
const char CameraParameters::FLASH_MODE_ZSL_TORCH_AUTO[] = "zsl-torch-auto";
...
const char CameraParameters::KEY_FACE_FILTER[] = "face-filter";
...
const char CameraParameters::KEY_HDR[] = "pantech-hdr";
...
const char CameraParameters::KEY_SUPPORTED_ANTISHAKE[] = "pantech-supported-antishake";
const char CameraParameters::KEY_SUPPORTED_HDR[] = "pantech-supported-hdr";
...
const char CameraParameters::SKY_IPL_CAM_CARTOON[] = "pantech-cam-cartoon";
...
}; // namespace androidFACE_FILTER_FACEDETECT
